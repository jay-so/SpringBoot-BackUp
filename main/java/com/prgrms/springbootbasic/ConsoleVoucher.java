        ...
        switch (VoucherSelectMenu.of(console.inputCommand())) {
            case ID -> {
                ...
                if (!voucherController.checkVoucherId(voucherId)) {
                    ...
                    System.out.println("voucherResponse 1 = " + voucherResponse.getVoucherId());
                    System.out.println("voucherResponse 2 = " + voucherResponse.getDiscount());
                    System.out.println("voucherResponse.getType() = " + voucherResponse.getType());
                }
            }
            //바우처 타입
            case TYPE -> {
