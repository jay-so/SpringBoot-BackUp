...
import com.prgrms.springbootbasic.exception.CustomerValidator;
import com.prgrms.springbootbasic.exception.VoucherValidator;
...
public class Console implements Input, Output {
    ...
    public VoucherCreateRequest inputVoucherCrateMessage(VoucherType type) {
        ...
        VoucherValidator.validateCreateVoucher(type, inputDiscount);
...
//        String[] customerInfo = CustomerValidator.inputParse(input.nextLine());
//
//        //CustomerValidator.validationCustomerLength(customerInfo);
...
//    }
    ...
    public CustomerUpdateRequest inputCustomerUpdateMessage(UUID customerId) {
        ...
        // 유효성 검사
        try {
            CustomerValidator.validateCreateVoucher(updateCustomerName, updateCustomerEmail);
        } catch (IllegalArgumentException e) {
    ...
    public void printCustomerSelectByCreatedAt(CustomerListResponse customerListResponse) {
        for (CustomerResponse customerResponse : customerListResponse.getCustomerResponseList()) {
            System.out.println("==== Voucher 조회 작업 ==== ");
            System.out.println("저장된 모든 바우처를 조회를 수행합니다.");
            System.out.println("바우처 ID : " + customerResponse.getCustomerId());
            System.out.println("할인 금액 : " + customerResponse.getCustomerEmail());
            System.out.println("바우처 타입 : " + customerResponse.getCustomerName());
            System.out.println("바우처 생성일 :" + customerResponse.getCreateAt());
            System.out.println();
        }
    }
    ...
    public CustomerCreateRequest inputCustomerCreateMessage() {
        ...
        CustomerValidator.validateCreateVoucher(inputCustomerName, inputCustomerEmail);
